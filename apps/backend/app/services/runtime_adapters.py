...
class _RuntimeAdapterBase:
    ...
    def normalize_terminal_session(self, session: RuntimeSessionRead) -> TerminalSessionRead:
        ...
        return TerminalSessionRead(
            ...
            cache_creation_input_tokens=getattr(session, "cache_creation_input_tokens", None),
            cache_read_input_tokens=getattr(session, "cache_read_input_tokens", None),
            total_input_tokens=getattr(session, "total_input_tokens", None),
            total_output_tokens=getattr(session, "total_output_tokens", None),
