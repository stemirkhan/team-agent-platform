...
import { createTeamReview, type Review } from "@/lib/api";
...
export function ReviewsSection({ teamSlug, initialReviews }: ReviewsSectionProps) {
  ...
  async function onSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const created = await createTeamReview(
        teamSlug,
        {
          rating,
